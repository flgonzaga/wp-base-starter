...
<div class="wrap about-wrap">
	<h1><?php _e( 'Welcome to WP Base Starter' ); ?></h1>
	...
	<h2 class="nav-tab-wrapper">
		<a href="#" class="nav-tab nav-tab-active"><?php _e( 'Step 1' ); ?></a>
		<a href="#" class="nav-tab"><?php _e( 'Step 2' ); ?></a>
		<a href="#" class="nav-tab"><?php _e( 'Step 3' ); ?></a>
	</h2>
